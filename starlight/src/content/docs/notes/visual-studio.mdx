...
| `Ctrl`+`K`, `Ctrl`+`E`                             | Run Code Cleanup - Format Document/Remove & Sort Usings/File Header Preferences<br />**Project → Code Cleanup → Run Code Cleanup (Profile 1) on Solution** |
