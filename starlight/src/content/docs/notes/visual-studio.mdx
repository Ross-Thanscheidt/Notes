...
| `Ctrl`+`K`, `Ctrl`+`D`                             | Format Document<br />(**Edit → Format Document**) |
| `Ctrl`+`R`, `Ctrl`+`G`                             | Remove and Sort `using` statements in C#<br />(right-click in Text Editor → **Remove and Sort Usings**) |
| `Ctrl`+`K`, `Ctrl`+`E`                             | Format Document / Remove and Sort Usings / File Header Preferences<br />(**Project → Code Cleanup → Run Code Cleanup (P1) on Solution**) |
