...
* Install the extension in Visual Studio 2026
* **Tools → Options → Environment → General**
  * Check **Use compact menu and search bar (requires restart)**
* **Tools → Options → Customize VS Window Title → Global rules**
...
These are my configuration tasks after installing or repairing Visual Studio 2026:
...
* Install Extensions:
  ...
  * Optional Extensions:
    ...
    * [SonarQube for Visual Studio](https://marketplace.visualstudio.com/items?itemName=SonarSource.SonarLintforVisualStudio2022)
